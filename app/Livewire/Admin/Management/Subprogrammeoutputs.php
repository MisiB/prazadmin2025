...
class Subprogrammeoutputs extends Component
{
    ...
    public $targetmatrixmodal = false;
    ...
    protected $targetmatrixrepository;
    public function boot(istrategyInterface $strategyrepo,iIndicatorInterface $indicatorrepository,iprogrammeInterface $programmerepository,ioutcomeInterface $outcomerepository,ioutputInterface $outputrepository,idepartmentInterface $departmentrepository,iTargetmatrixInterface $targetmatrixrepository)
    {
        ...
        $this->targetmatrixrepository = $targetmatrixrepository;
    }
  ...
  public function saveoutcome(){
    ...
    public function render()
    {
        return view('livewire.admin.management.subprogrammeoutputs',[
            ...
            'headerstargetmatrix'=>$this->headerstargetmatrix(),

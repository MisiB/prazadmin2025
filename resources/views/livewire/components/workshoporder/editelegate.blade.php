<div>
    <x-button icon="o-pencil" class="btn-info btn-sm" label="Edit" wire:click="showEditDelegateModal = true" />
    <x-modal wire:model="showEditDelegateModal" title="Edit Delegate">
